/* calculadora stack inversa */

/* pide ingreso de expresiones en notación de pila inversa (stack) hasta
   obtener un caracter EOF (fin de archivo, Ctrl-D).
   Ejemplo de notación stack:
      la expresión
	 (10 - 8) * (4 + 5)
      se escribe
	 10 8 - 4 5 + *
...
main()
{
  ...
  printf("\nCALCULADORA POLACA.\n");
  printf("Ingrese expresiones en pila .\n");
